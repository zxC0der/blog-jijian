...
module.exports = (md, options) => {
  ...
  let Inline = async (latex) => {
    let res=await getSvg(latex);
    console.log(res);
    return res;
    // try {
  ...
  md.renderer.rules.math_inline = async (tokens, idx) => {
    return await Inline(tokens[idx].content);
  };
...
// https://latex.oncodecogs.com/svg.image?